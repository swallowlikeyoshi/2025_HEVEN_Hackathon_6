...
class ControlNode:
    ...
    def pure_pursuit(self, lookahead=2.0, wheelbase=0.3, target_speed=2.0):
        ...
        rospy.loginfo(f"PP: x={x:.2f}, y={y:.2f}, theta={theta_deg:.2f}, v={v:.2f}, "
                ...
                f"alpha={np.degrees(alpha):.2f}, steer={steering:.2f}, "
